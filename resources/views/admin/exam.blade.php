                    ...
                    <div class="modal-content">
                        ...
                        <form id="addExam">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="date" class="form-control form-control-alt" name="date" required min="@php echo date('Y-m-d'); @endphp" max="@php echo date('Y-m-d'); @endphp">
                                </br>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="editExam">
                            ...
                            <div class="modal-body">
                                ...
                                <label for="" class="form-label">Ngày tháng</label>
                                <input type="date" id="date" class="form-control form-control-alt" name="date" require min="@php echo date('Y-m-d'); @endphp" max="@php echo date('Y-m-d'); @endphp">
                                </br>
                                <label for="" class="form-label">Thời gian thi (phút)</label>
                        ...
                        @foreach($exams as $exam)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="addQuestion" data-id="{{$exam->id}}" data-subject-id="{{$exam->subjects[0]['id']}}" data-bs-target="#addQnaModal" data-bs-toggle="modal">Thêm câu hỏi</a>
                                </td>
                                <td class="text-center">
                                ...
                                <td>
                                    <div class="text-center inline-block">
                                        <button class="btn btn-danger deletebutton" data-bs-toggle="modal" data-id="{{$exam->id  }}" data-bs-target="#deleteExamModal">Xóa</button>
                                    </div>
                                </td>
                                <td class="text-center">
                                    <button class="btn btn-success editbutton" data-bs-toggle="modal" data-id="{{$exam->id  }}" data-bs-target="#editExamModal">Sửa</button>
                                </td>
                            </tr>
                        @endforeach
...
// Xóa câu hỏi
            ...
            {{-- trang thêm câu hỏi vào bài kiểm tra--}}
            {{-- css--}}
            <style>
                .search-input {
                    width: 100%;
