    ...
    <div class="body-wrapper">
      ...
      {{-- main content end --}}
        <div class="container-fluid py-6 px-6 text-center">
            <p class="mb-0 fs-4">Design and Developed by <a href="https://www.facebook.com/fitatest" target="_blank" class="pe-1 text-primary text-decoration-underline">FITA-VNUA</a> Distributed by <a href="https://www.facebook.com/fitatest">FITA</a></p>
        </div>
    </div>
  </div>
