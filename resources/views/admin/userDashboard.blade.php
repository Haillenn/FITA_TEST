                            ...
                            <div class="modal-body ">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <input type="date" class="form-control form-control-alt" name="birth" placeholder="Nhập ngày tháng năm sinh" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="radio" name="role" value="2" class="radio"> Teacher</input></br>
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        ...
                                        <input type="date" class="form-control form-control-alt" name="birth" id="birth_edit" placeholder="Nhập ngày tháng năm sinh" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col">
                ...
                @if(count($users) > 0)
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class="text-center"><span style="color:{{ $user->gender ? 'black' : 'red' }}">{{ $user->gender ?? 'chưa cập nhật thông tin' }}</span></td>
