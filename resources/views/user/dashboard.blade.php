        ...
        <div class="container text-center">
            <div class="d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <a href="https://www.youtube.com/watch?v=CNf-t45XUZg" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <a href="#" class="read-more"><span>Tìm hiểu thêm</span><i class="bi bi-arrow-right"></i></a>
                </div>
    ...
    <section  class="clients section">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-2 col-md-3 col-6 client-logo">
                    <img src="{{ asset('/public/asset_home') }}/img/logosql.png" class="img-fluid" alt="">
                </div><!-- End Client Item -->
                ...
                <div class="col-xl-2 col-md-3 col-6 client-logo">
                    <img src="{{ asset('/public/asset_home') }}/img/logojqr.png" class="img-fluid" alt="">
                </div><!-- End Client Item -->

                <div class="col-xl-2 col-md-3 col-6 client-logo">
                    <img src="{{ asset('/public/asset_home') }}/img/logossl.png" class="img-fluid" alt="">
                </div><!-- End Client Item -->
