                 ...
                 <ul>
                     ...
                     <li>
                         <button class="noti" data-bs-toggle="modal" data-bs-target="#notificationModal">
                             ...
                             <span class="notification-count">{{$notification_count}}</span> <!-- Số thông báo -->
                         </button>
                     </li>
                         ...
                         <li class="nav-item dropdown">
                             ...
                             @else
                                 <a class="nav-link nav-icon-hover" href="/login">
                                     <img src="{{asset('/public/assets')}}/images/profile/default.jpg" alt="" width="35" height="35" class="rounded-circle">
                                     Đăng nhập
                                 </a>
                             @endif
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-8">
                                         <form action="{{ route('updateProfile', ['id' => Auth::user()->id]) }}" method="post" enctype="multipart/form-data">
                                             ...
                                             <div class="modal-footer">
                                                 <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                 <button type="submit" class="btn btn-primary profileUser">Save changes</button>
                                             </div>
                                         </form>
                                     </div>
                                 </div>
